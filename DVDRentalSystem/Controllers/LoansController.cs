...
namespace DVDRentalSystem.Controllers
{
    public class LoansController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "LoanId,DVDDetailsId,IssueDate,ReturnDate,FineAmount,MemberId,CopyId,ActualReturnedDate")] Loan loan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "LoanId,DVDDetailsId,IssueDate,ReturnDate,FineAmount,MemberId,CopyId,ActualReturnedDate")] Loan loan)
        {
            if (ModelState.IsValid)
            {
